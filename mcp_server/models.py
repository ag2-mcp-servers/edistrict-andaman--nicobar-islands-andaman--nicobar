...
class CertificateParameters(BaseModel):
    CertificateNumber: str = Field(
        ..., description='Certificate Number', examples=['20190101IN00098']
    )
...
class BrlcsCertificatePostRequest(BaseModel):
...
class BrlcsCertificatePostResponse(BaseModel):
...
class BrlcsCertificatePostResponse1(BaseModel):
...
class BrlcsCertificatePostResponse2(BaseModel):
...
class BrlcsCertificatePostResponse3(BaseModel):
...
class BrlcsCertificatePostResponse4(BaseModel):
...
class BrlcsCertificatePostResponse5(BaseModel):
...
class BrlcsCertificatePostResponse6(BaseModel):
...
class LccepCertificatePostRequest(BaseModel):
    certificateParameters: Optional[CertificateParameters] = None
    consentArtifact: Optional[ConsentArtifactSchema] = None
    format: Format = Field(
        ..., description='The format of the certificate in response.'
...
class LccepCertificatePostResponse(BaseModel):
...
class LccepCertificatePostResponse1(BaseModel):
...
class LccepCertificatePostResponse2(BaseModel):
...
class LccepCertificatePostResponse3(BaseModel):
...
class LccepCertificatePostResponse4(BaseModel):
...
class LccepCertificatePostResponse5(BaseModel):
...
class LccepCertificatePostResponse6(BaseModel):
    error: Optional[Error34] = None
    errorDescription: Optional[ErrorDescription34] = None


class NdcerCertificatePostRequest(BaseModel):
    certificateParameters: Optional[CertificateParameters] = None
    consentArtifact: Optional[ConsentArtifactSchema] = None
    format: Format = Field(
        ..., description='The format of the certificate in response.'
...
class NdcerCertificatePostResponse(BaseModel):
...
class NdcerCertificatePostResponse1(BaseModel):
...
class NdcerCertificatePostResponse2(BaseModel):
...
class NdcerCertificatePostResponse3(BaseModel):
...
class NdcerCertificatePostResponse4(BaseModel):
...
class NdcerCertificatePostResponse5(BaseModel):
...
class NdcerCertificatePostResponse6(BaseModel):
...
class RucerCertificatePostRequest(BaseModel):
    certificateParameters: Optional[CertificateParameters] = None
    consentArtifact: Optional[ConsentArtifactSchema] = None
    format: Format = Field(
        ..., description='The format of the certificate in response.'
...
class RucerCertificatePostResponse(BaseModel):
...
class RucerCertificatePostResponse1(BaseModel):
...
class RucerCertificatePostResponse2(BaseModel):
...
class RucerCertificatePostResponse3(BaseModel):
...
class RucerCertificatePostResponse4(BaseModel):
...
class RucerCertificatePostResponse5(BaseModel):
...
class RucerCertificatePostResponse6(BaseModel):
